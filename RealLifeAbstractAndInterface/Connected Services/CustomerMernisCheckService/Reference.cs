...
namespace CustomerMernisCheckService
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://tckimlik.nvi.gov.tr/WS", ConfigurationName="CustomerMernisCheckService.KPSPublicSoap")]
    public interface KPSPublicSoap
    {
        ...
        CustomerMernisCheckService.TCKimlikNoDogrulaResponse TCKimlikNoDogrula(CustomerMernisCheckService.TCKimlikNoDogrulaRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tckimlik.nvi.gov.tr/WS/TCKimlikNoDogrula", ReplyAction="*")]
        System.Threading.Tasks.Task<CustomerMernisCheckService.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(CustomerMernisCheckService.TCKimlikNoDogrulaRequest request);
    }
    ...
    public partial class TCKimlikNoDogrulaRequest
    {
        ...
        public CustomerMernisCheckService.TCKimlikNoDogrulaRequestBody Body;
        
        public TCKimlikNoDogrulaRequest()
        {
        }
        
        public TCKimlikNoDogrulaRequest(CustomerMernisCheckService.TCKimlikNoDogrulaRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class TCKimlikNoDogrulaResponse
    {
        ...
        public CustomerMernisCheckService.TCKimlikNoDogrulaResponseBody Body;
        
        public TCKimlikNoDogrulaResponse()
        {
        }
        
        public TCKimlikNoDogrulaResponse(CustomerMernisCheckService.TCKimlikNoDogrulaResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public interface KPSPublicSoapChannel : CustomerMernisCheckService.KPSPublicSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<CustomerMernisCheckService.KPSPublicSoap>, CustomerMernisCheckService.KPSPublicSoap
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        CustomerMernisCheckService.TCKimlikNoDogrulaResponse CustomerMernisCheckService.KPSPublicSoap.TCKimlikNoDogrula(CustomerMernisCheckService.TCKimlikNoDogrulaRequest request)
        {
        ...
        {
            CustomerMernisCheckService.TCKimlikNoDogrulaRequest inValue = new CustomerMernisCheckService.TCKimlikNoDogrulaRequest();
            inValue.Body = new CustomerMernisCheckService.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            CustomerMernisCheckService.TCKimlikNoDogrulaResponse retVal = ((CustomerMernisCheckService.KPSPublicSoap)(this)).TCKimlikNoDogrula(inValue);
            return retVal.Body.TCKimlikNoDogrulaResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<CustomerMernisCheckService.TCKimlikNoDogrulaResponse> CustomerMernisCheckService.KPSPublicSoap.TCKimlikNoDogrulaAsync(CustomerMernisCheckService.TCKimlikNoDogrulaRequest request)
        {
            return base.Channel.TCKimlikNoDogrulaAsync(request);
        }
        
        public System.Threading.Tasks.Task<CustomerMernisCheckService.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(long TCKimlikNo, string Ad, string Soyad, int DogumYili)
        {
            CustomerMernisCheckService.TCKimlikNoDogrulaRequest inValue = new CustomerMernisCheckService.TCKimlikNoDogrulaRequest();
            inValue.Body = new CustomerMernisCheckService.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            ...
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            return ((CustomerMernisCheckService.KPSPublicSoap)(this)).TCKimlikNoDogrulaAsync(inValue);
        }
